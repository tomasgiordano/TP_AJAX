...
namespace Main{
    ...
    export function ModificarEmpleado(nombre:string,apellido:string,dni:string,legajo:string,sexo:string,turno:string,sueldo:string):void {
        ...
        let turnos : HTMLCollectionOf<HTMLInputElement> = <HTMLCollectionOf<HTMLInputElement>><unknown> document.getElementsByName("rdoTurno");
...
function ObtenerTurnoSeleccionado():string{
        ...
        let checks : HTMLCollectionOf<HTMLInputElement> = <HTMLCollectionOf<HTMLInputElement>><unknown> document.getElementsByName("rdoTurno");
